...
def research_agent(state:graphState):
    ...
    content='''Think in step by step what all information do you need regrading a praticular topic to generate a summary and research report.
    Tools that you can use: wikipedia_retriever_tool and websearch_tool.
    Both the the tools accepts string query.
    Keep filtering the data or information you recieve if they are not relevent.
    But the information block you retrieve will act as base data for a research paper so it should be detailed.
    ...
    if topic:
        ...
        return {'reasearched_info': results['messages'][-1].content}
